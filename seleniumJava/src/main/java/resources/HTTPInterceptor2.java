...
public class HTTPInterceptor2 {
	
	public static HttpResponse GetRespose(String URL_ToCheck) throws Exception{
	      ...
	      HttpGet httpget1 = new HttpGet(URL_ToCheck);
	      //HttpGet httpget1 = new HttpGet("https://www.phptravels.net/account/");
