...
public class Registration_3Test extends InitializationB {

	// Test Goal:First letter in first Name field is not capital
	...
	@Test
	public void Reg_FirstName3() throws IOException, Exception {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("FirstName3");
		...
		// Check MSG
		// Assert.assertEquals(error_Message, "Fisrst Letter must be capital.");
