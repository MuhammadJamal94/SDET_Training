...
public class Reg_Pass4_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in case password has no Upper case char
	// characters
	...
	public void Reg_Pass1() throws IOException, Exception {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Password4");
