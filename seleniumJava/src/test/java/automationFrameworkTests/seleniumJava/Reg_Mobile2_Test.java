...
public class Reg_Mobile2_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in case phone number is too short
	...
	@Test
	public void Reg_Mobile2() throws IOException, Exception {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Mobile2");
		...
		// Check MSG
		// Assert.assertEquals(error_Message, "Phone number is too short.");
