...
public class Registration_5Test extends InitializationB {

	// Test Goal:First Name field can't be equal Last Name
	...
	@Test
	public void Reg_FirstName5() throws IOException, Exception {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("FirstName5");
