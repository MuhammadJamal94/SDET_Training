...
public class Reg_Mobile3_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in case phone number contains
	// characters
	...
	@Test
	public void Reg_Mobile3() throws IOException, Exception {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Mobile3");
