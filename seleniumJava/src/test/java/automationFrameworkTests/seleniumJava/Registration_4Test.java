...
public class Registration_4Test extends InitializationB {

	// Test Goal:First Name field can not start with special characters and contains
	// numbers
	...
	@Test
	public void Reg_FirstName4() throws IOException, Exception {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("FirstName4");
		...
		// Check MSG
		// Assert.assertEquals(error_Message, "Name should not contain special
