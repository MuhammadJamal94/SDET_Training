...
public class Reg_Pass5_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in case password field is empty
	// characters
	...
	public void Reg_Pass1() throws IOException {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Password5");
		...
		// Check the error MSG
		error_Message = RegPage.getPassword().getAttribute("validationMessage");
