...
public class Reg_Mobile1_Test extends InitializationB {

	// Test Goal:Missing Mobile Number data
	...
	@Test
	public void Reg_Mobile1() throws IOException {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Mobile1");
		...
		// Check the error MSG
		error_Message = RegPage.getPhone().getAttribute("validationMessage");
