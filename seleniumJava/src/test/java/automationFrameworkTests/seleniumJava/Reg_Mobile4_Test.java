...
public class Reg_Mobile4_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in case phone number contains Special
	// characters
	...
	@Test
	public void Reg_Mobile4() throws IOException, Exception {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Mobile4");
		...
		// Check MSG
		// Assert.assertEquals(error_Message, "Phone number Cant contains chars.");
