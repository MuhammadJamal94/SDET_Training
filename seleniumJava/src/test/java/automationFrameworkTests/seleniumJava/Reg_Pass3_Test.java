...
public class Reg_Pass3_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in case password has no small char
	// characters
	...
	public void Reg_Pass1() throws IOException, Exception {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Password3");
