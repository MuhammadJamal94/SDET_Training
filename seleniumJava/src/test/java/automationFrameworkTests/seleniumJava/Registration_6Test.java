...
public class Registration_6Test extends InitializationB {

	// Test Goal:Missing Last Name field
	...
	@Test
	public void Reg_LastName6() throws IOException {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("FirstName6");
		...
		// Check the error MSG
		error_Message = RegPage.getLastName().getAttribute("validationMessage");
