...
public class Reg_Email3_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in case Email field is empty
	...
	@Test
	public void Reg_Email3() throws IOException {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Email3");
		...
		// Check the error MSG
		error_Message = RegPage.getEmail().getAttribute("validationMessage");
