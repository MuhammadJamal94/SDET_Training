...
public class Reg_Email2_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in Email does not contain .XYZ part
	...
	@Test
	public void Reg_Email2() throws IOException {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Email2");
		...
		// Check MSG
		Assert.assertEquals(error_Message, "The Email field must contain a valid email address.");
	}
