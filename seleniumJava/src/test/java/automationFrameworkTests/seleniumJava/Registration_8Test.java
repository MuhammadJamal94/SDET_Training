...
public class Registration_8Test extends InitializationB {

	// Test Goal:Last Name field can not start with special characters and contains
	// numbers
	...
	@Test
	public void Reg_LastName8() throws IOException, Exception {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("FirstName7");
