...
public class Reg_Email4_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in case Email is already associated to
	// an account
	...
	@Test
	public void Reg_Email4() throws IOException {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Email4");
		...
		// Check MSG
		Assert.assertEquals(error_Message, "Email Already Exists.");
	}
