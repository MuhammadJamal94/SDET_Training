...
public class Reg_Pass1_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in case password < 6 chars
	// characters
	...
	public void Reg_Pass1() throws IOException {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Password1");
		...
		// Check MSG
		Assert.assertEquals(error_Message, "The Password field must be at least 6 characters in length.");
	}
