...
public class Reg_Email1_Test extends InitializationB {

	// Test Goal:Check error MSG will appear in Email does not contain @
	...
	@Test
	public void Reg_Email1() throws IOException {
		...
		DDT excel = new DDT();
		ArrayList x = excel.getData("Email1");
